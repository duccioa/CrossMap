...
# Export the results to CSV 
    csv_filename = dest_folder + 'rightmove_'+rent_or_buy+'_results_'+str(dt.datetime.today().strftime("%Y_%m_%d %H %M %S"))+'.csv'
...
rightmove_url = 'http://www.rightmove.co.uk/property-to-rent/find.html?locationIdentifier=STATION%5E1754&radius=0.5&propertyTypes=bungalow%2Cdetached%2Cflat%2Csemi-detached%2Cterraced&includeLetAgreed=false&areaSizeUnit=sqm'
...
rightmove_url = "http://www.rightmove.co.uk/property-to-rent/find.html?locationIdentifier=STATION%5E1754&radius=0.5&propertyTypes=bungalow%2Cdetached%2Cflat%2Csemi-detached%2Cterraced&includeLetAgreed=false&areaSizeUnit=sqm"
buy_url1 = "http://www.rightmove.co.uk/property-for-sale/find.html?locationIdentifier=STATION%5E1754&radius=0.5&propertyTypes=bungalow%2Cdetached%2Cflat%2Csemi-detached%2Cterraced&includeLetAgreed=false&areaSizeUnit=sqm"
df1 = rightmove_webscrape(url,'buy', "/Users/duccioa/CLOUD/01_Cloud/01_Work/04_Projects/0031_CrossMap/05_Data/")
df2 = rightmove_webscrape(buy_url1,'buy', "/Users/duccioa/CLOUD/01_Cloud/01_Work/04_Projects/0031_CrossMap/05_Data/")

'http://www.rightmove.co.uk/property-to-rent/find.html?locationIdentifier=STATION%5E1754&radius=0.5&propertyTypes=bungalow%2Cdetached%2Cflat%2Csemi-detached%2Cterraced&includeLetAgreed=false&areaSizeUnit=sqm'